...
const sectionTitles: Record<Section, [string, string]> = {
  ...
  clasificacion: ["Clasificación", "Liga Amigos · Temporada 2025/26"],
  ...
  return (
    <div className="app-shell">
      <aside className={`sidebar ${mobileNav ? "mobile-open" : ""}`}>
        ...
        <button className="league-picker"><span className="league-avatar">LA</span><span><small>LIGA ACTUAL</small><strong>Liga Amigos</strong></span><ChevronDown /></button>
